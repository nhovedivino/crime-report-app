        ...
        <q-card-section>
          ...
          <form @submit.prevent.stop="onSubmit" @reset.prevent.stop="onReset" class="q-gutter-md">
            ...
            <div class="actions md-layout md-alignment-center">
              <q-btn color="green" @click="onSubmit" :loading="loading" label="Submit" />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <q-btn color="primary" @click="signIn" label="Sign In" />
            </div>
          </form>
        </q-card-section>
      </q-card>
...
export default {
  ...
  methods: {
    isValidEmail () {
      ...
      return emailPattern.test(this.formData.email) || 'Invalid email'
    },
    signIn () {
      this.$router.push('/')
    },
    onSubmit () {
      ...
      this.$refs.contact_no.validate()
      this.$refs.email.validate()
      this.$refs.password.validate()
      this.$refs.password_confirmation.validate()

      if (this.$refs.first_name.hasError || this.$refs.last_name.hasError || this.$refs.birth_date.hasError || this.$refs.contact_no.hasError || this.$refs.email.hasError || this.$refs.password.hasError || this.$refs.password_confirmation.hasError) {
    ...
    onReset () {
      ...
      this.$refs.contact_no.resetValidation()
