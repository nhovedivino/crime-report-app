<template>
  <div class="q-pa-md flex flex-center q-pa-md row items-start q-gutter-md">
    <q-card v-for="(data, index) in lost_and_founds.data" :key="index" class="my-card">
    ...
    <q-card v-if="lost_and_founds.data.length === 0">
      <q-card-section>
...
export default {
  ...
  created () {
    this.getLostAndFound()
  },
  methods: {
    getLostAndFound () {
      this.$store.dispatch('lost/getLostAndFound')
    }
  },
  computed: {
    ...mapGetters('lost', {
